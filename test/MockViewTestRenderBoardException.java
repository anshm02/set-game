 ...
 * the controller can successfully handle an IOException thrown by renderBoard.
 */
public class MockViewTestRenderBoardException implements SetGameView {
   ...
   */
  public MockViewTestRenderBoardException(Appendable ap, SetGameModelState setModel) {
